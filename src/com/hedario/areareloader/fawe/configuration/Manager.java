...
public class Manager {
	...
	private void loadConfig(Config configurationFile) {
		...
		config.addDefault("Commands.Create.Description",
				...
				+ "&e[async] &6Runs the creation process asynchronously, taking the weight off the main thread.\n"
				+ "This can help reduce lag spikes and prevent general tps drops when creating heavy chunk areas.\n"
				+ "If the area has copied entities, the task will be forced to run synchronously.");
